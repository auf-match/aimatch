...
АУФ Match — внутренний инструмент рекрутингового агентства АУФ, специализирующегося на найме дизайнеров. Система автоматически анализирует резюме и портфолио кандидатов, структурирует данные, и матчит кандидатов с вакансиями, выдавая ранжированный список с процентом соответствия и объяснениями.

### Пользователи
- **Дизайн-лид** (Слава) — оценивает качество портфолио, принимает решения по кандидатам
- **Рекрутер** — управляет вакансиями, скорит кандидатов, формирует шорт-листы
...
### Критерий успеха
- В топ-10 рекомендаций минимум 3 реально сильных и релевантных кандидата
- Сокращение времени на первичный скрининг
- Больший объём просматриваемых кандидатов
