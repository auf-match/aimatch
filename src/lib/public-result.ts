 ...
 *
 * Раньше карточка просто исчезала: у одного портфолио на публичной
 * странице не было ни строчки про визуал, хотя страница называется
 * «Прожарочная» и визуал в ней главный. Пропажа читается как поломка,
 * поэтому пустоту объясняем.
 */
const БЕЗ_ОЦЕНКИ_ВИЗУАЛА =
  "Оценить не вышло: в портфолио не нашлось работ, по которым это видно — " +
  "только названия проектов или текст без изображений.";
